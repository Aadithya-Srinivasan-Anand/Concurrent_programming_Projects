...
void write_to_file(string output_file_name)     //Writes the counter value to file
{
...
{
    unsigned long long elapsed_ns;      // counting in nano seconds
...
void *counter_thread(void *input)
{
    ...
    {
        node *thread_node = new node(); // init thread node of node type
        ...
        counter++;          // critical section to be locked 
